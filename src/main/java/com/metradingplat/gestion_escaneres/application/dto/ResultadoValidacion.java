 ...
 *
 * @param enumFiltro El tipo de filtro al que pertenece el parámetro (ej: RSI, VOLUME)
 * @param enumParametro El tipo de parámetro que falló la validación (ej: PERIODO_RSI, CONDICION)
 * @param mensaje Clave del mensaje de error internacionalizable
 * @param args Argumentos opcionales para la internacionalización del mensaje
 */
