...
public class FiltroFactoryRelativeVolumeSameTime implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.RELATIVE_VOLUME_SAME_TIME;
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            valorUsuario != null ? valorUsuario.getValor1() : 200.0F,
            valorUsuario != null ? valorUsuario.getValor2() : 800.0F
        );
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarCondicional(this.enumFiltro, EnumParametro.CONDICION, valoresSeleccionados.get(EnumParametro.CONDICION), 20.0F, 2_000.0F)
