...
public class FiltroFactoryShortRatio implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.SHORT_RATIO;
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarCondicional(this.enumFiltro, EnumParametro.CONDICION, valoresSeleccionados.get(EnumParametro.CONDICION), 0.0F, 30.0F)
