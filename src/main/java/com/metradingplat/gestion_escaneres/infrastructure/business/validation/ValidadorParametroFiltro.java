 ...
 *
 * <p>Este servicio actúa como un Factory que crea y ejecuta estrategias de validación
 * según el tipo de parámetro a validar. Cada método factory crea la estrategia
 * apropiada y delega la validación a ella.
 *
 * <p><b>Patrón:</b> Strategy Pattern con Factory Method
 *
 * <p><b>Uso:</b>
 * <pre>{@code
...
public class ValidadorParametroFiltro {
     ...
     * Este método encapsula la creación de la estrategia concreta.
     */
    private <E extends Enum<E> & IEnumValores> IValidacionFiltro crearEstrategiaStringConOpciones(List<E> opcionesPermitidas) {
