...
public class FiltroFactoryVolume implements IFiltroFactory {
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            enumTipoValor,
            enumCondicional,
            valorUsuario != null && valorUsuario.getIsInteger() != null ? valorUsuario.getIsInteger() : false,  // isInteger = true (volumen de acciones)
    ...
    private Parametro crearParametroTipoVolumen(ValorString valorUsuario) {
        ...
        List<Valor> opciones = this.obtenerOpciones(EnumTipoVolumen.values());
