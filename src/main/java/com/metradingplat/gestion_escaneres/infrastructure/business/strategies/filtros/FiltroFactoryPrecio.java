...
public class FiltroFactoryPrecio implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.PRECIO;
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarCondicional(this.enumFiltro, EnumParametro.CONDICION, valoresSeleccionados.get(EnumParametro.CONDICION), 0.0001F,
                10_000.0F)
