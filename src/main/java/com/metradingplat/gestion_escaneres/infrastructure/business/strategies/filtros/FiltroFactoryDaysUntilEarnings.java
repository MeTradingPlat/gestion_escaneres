...
public class FiltroFactoryDaysUntilEarnings implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.DAYS_UNTIL_EARNINGS;
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            enumTipoValor,
            enumCondicional,
            valorUsuario != null && valorUsuario.getIsInteger() != null ? valorUsuario.getIsInteger() : false,  // isInteger = true (días hasta earnings)
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarCondicional(this.enumFiltro, EnumParametro.CONDICION, valoresSeleccionados.get(EnumParametro.CONDICION), 0.0F, 365.0F)
