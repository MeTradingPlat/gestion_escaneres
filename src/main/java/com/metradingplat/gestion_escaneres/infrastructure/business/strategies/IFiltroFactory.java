package com.metradingplat.gestion_escaneres.infrastructure.business.strategies;
 ...
 *
 * <p><b>Patrón de Diseño:</b> Abstract Factory Pattern
 *
 * <p>Esta interfaz NO implementa el patrón Strategy a pesar del nombre histórico "Estrategia".
 ...
 *
 * <p>Las implementaciones NO son intercambiables entre sí porque cada una crea
 ...
 * </ul>
 *
 * <p><b>Implementaciones concretas:</b> Existen 41 implementaciones, una por cada
 * tipo de filtro: {@code FiltroFactoryPrecio}, {@code FiltroFactoryVolume}, etc.
 *
 * <p><b>Uso típico:</b>
 * <pre>{@code
...
public interface IFiltroFactory {
     ...
     *
     * @param valoresSeleccionados Mapa de parámetros con valores seleccionados por el usuario
