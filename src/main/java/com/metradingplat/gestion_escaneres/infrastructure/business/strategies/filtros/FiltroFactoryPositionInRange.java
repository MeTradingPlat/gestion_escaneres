...
public class FiltroFactoryPositionInRange implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.POSITION_IN_RANGE;
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        parametros.add(this.crearParametroTimeframe((ValorString)valoresSeleccionados.get(EnumParametro.TIMEFRAME_POSITION_IN_RANGE)));
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            valorUsuario != null ? valorUsuario.getValor1() : 20.0F,
            valorUsuario != null ? valorUsuario.getValor2() : 80.0F
        );
    ...
    private Parametro crearParametroTimeframe(ValorString valorUsuario) {
        ...
        return new Parametro(EnumParametro.TIMEFRAME_POSITION_IN_RANGE, EnumParametro.TIMEFRAME_POSITION_IN_RANGE.getEtiqueta(), valor, opciones);
    }
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarString(this.enumFiltro, EnumParametro.TIMEFRAME_POSITION_IN_RANGE,
                valoresSeleccionados.get(EnumParametro.TIMEFRAME_POSITION_IN_RANGE), EnumTimeframe.class)
                .ifPresent(errores::add);
