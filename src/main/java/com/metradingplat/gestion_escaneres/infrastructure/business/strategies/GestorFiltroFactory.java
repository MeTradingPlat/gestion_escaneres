 ...
 *
 * <p><b>Patrones de Diseño:</b>
 * <ul>
 *   <li><b>Registry Pattern:</b> Mantiene un registro de todas las factorías de filtros disponibles</li>
 *   <li><b>Facade Pattern:</b> Proporciona una interfaz simplificada para acceder a las factorías</li>
 * </ul>
 *
 * <p>Esta clase gestiona el ciclo de vida y acceso a las 41 implementaciones de
 * {@link IFiltroFactory}. Spring inyecta automáticamente todas las implementaciones
