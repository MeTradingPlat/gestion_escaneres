...
public class FiltroFactoryMinutosInMarket implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.MINUTOS_IN_MARKET;
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        parametros.add(this.crearParametroMinutosTranscurridos((ValorInteger)valoresSeleccionados.get(EnumParametro.MINUTOS_TRANSCURRIDOS)));
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            enumTipoValor,
            enumCondicional,
            valorUsuario != null && valorUsuario.getIsInteger() != null ? valorUsuario.getIsInteger() : false,  // isInteger = true (minutos transcurridos)
    ...
    private Parametro crearParametroMinutosTranscurridos(ValorInteger valorUsuario) {
        ...
        return new Parametro(EnumParametro.MINUTOS_TRANSCURRIDOS, EnumParametro.MINUTOS_TRANSCURRIDOS.getEtiqueta(), valor, opciones);
    }
