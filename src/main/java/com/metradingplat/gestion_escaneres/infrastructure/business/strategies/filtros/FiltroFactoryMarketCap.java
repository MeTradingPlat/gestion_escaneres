...
public class FiltroFactoryMarketCap implements IFiltroFactory {
    private final EnumFiltro enumFiltro = EnumFiltro.MARKET_CAP;
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarCondicional(this.enumFiltro, EnumParametro.CONDICION, valoresSeleccionados.get(EnumParametro.CONDICION), 1_000_000.0F,
