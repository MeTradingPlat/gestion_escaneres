package com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.mappers;
...
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOAnswer.ValorCondicionalDTORespuesta;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOAnswer.ValorDTORespuesta;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOAnswer.ValorFloatDTORespuesta;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOAnswer.ValorIntegerDTORespuesta;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOAnswer.ValorStringDTORespuesta;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.FiltroDtoPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ParametroDTOPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ValorCondicionalDTOPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ValorDTOPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ValorFloatDTOPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ValorIntegerDTOPeticion;
import com.metradingplat.gestion_escaneres.infrastructure.input.controllerGestionarFiltro.DTOPetition.ValorStringDTOPeticion;
