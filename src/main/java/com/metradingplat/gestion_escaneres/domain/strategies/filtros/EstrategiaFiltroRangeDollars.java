...
public class EstrategiaFiltroRangeDollars implements IEstrategiaFiltro {
    private final EnumFiltro enumFiltro = EnumFiltro.RANGE_DOLLARS;
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        parametros.add(this.crearParametroTimeframe((ValorString)valoresSeleccionados.get(EnumParametro.TIMEFRAME_RANGE_DOLLAR)));
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            valorUsuario != null ? valorUsuario.getValor2() : 20.0F
        );
    ...
    private Parametro crearParametroTimeframe(ValorString valorUsuario) {
        ...
        return new Parametro(EnumParametro.TIMEFRAME_RANGE_DOLLAR, EnumParametro.TIMEFRAME_RANGE_DOLLAR.getEtiqueta(), valor, opciones);
    }
