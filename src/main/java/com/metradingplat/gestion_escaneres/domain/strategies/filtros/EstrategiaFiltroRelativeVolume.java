...
public class EstrategiaFiltroRelativeVolume implements IEstrategiaFiltro {
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        parametros.add(this.crearParametroTimeframe((ValorString)valoresSeleccionados.get(EnumParametro.TIMEFRAME_RELATIVE_VOLUME_PERCENT)));
    ...
    private Parametro crearParametroCondicion(ValorCondicional valorUsuario) {
        ...
        ValorCondicional valor = new ValorCondicional(
            ...
            enumTipoValor,
            enumCondicional,
            valorUsuario != null ? valorUsuario.getValor1() : 150.0F,
            valorUsuario != null ? valorUsuario.getValor2() : 500.0F
        );
    ...
    private Parametro crearParametroTimeframe(ValorString valorUsuario) {
        ...
        return new Parametro(EnumParametro.TIMEFRAME_RELATIVE_VOLUME_PERCENT, EnumParametro.TIMEFRAME_RELATIVE_VOLUME_PERCENT.getEtiqueta(), valor, opciones);
    }
