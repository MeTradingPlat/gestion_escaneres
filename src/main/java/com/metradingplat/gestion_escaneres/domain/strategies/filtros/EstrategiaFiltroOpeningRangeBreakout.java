...
public class EstrategiaFiltroOpeningRangeBreakout implements IEstrategiaFiltro {
    ...
    public Filtro obtenerFiltro(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        parametros.add(this.crearParametroTimeframe((ValorString)valoresSeleccionados.get(EnumParametro.TIMEFRAME_OPENING_RANGE_BREAKOUT)));
    ...
    public List<ResultadoValidacion> validarValoresSeleccionados(Map<EnumParametro, Valor> valoresSeleccionados) {
        ...
        this.objValidador.validarString(EnumParametro.TIMEFRAME_OPENING_RANGE_BREAKOUT,
                valoresSeleccionados.get(EnumParametro.TIMEFRAME_OPENING_RANGE_BREAKOUT), EnumTimeframe.class)
